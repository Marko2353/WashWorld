...
export default function LocationCard() {
  return (
<div className="max-w-sm mx-2 my-4 overflow-hidden bg-white rounded-lg shadow-md">
  <img src="ruta/a/la/imagen.jpg" alt="imagen" className="object-cover w-full h-48" />
