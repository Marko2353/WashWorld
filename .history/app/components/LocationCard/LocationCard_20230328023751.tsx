...
export default function LocationCard({ name, status, url }: any) {
  return (
    ...
    <div >
      <img src={place} alt="img" {status == "available" ? className="max-w-sm mx-2 my-4 overflow-hidden shadow-lg bg-grey" : className="max-w-sm mx-2 my-4 overflow-hidden shadow-lg bg-blue"} className="object-cover w-full h-48" />
