...
export default function LocationCard({ name, status, url }: any) {
  return (
    ...
    <div className={status != "available" ? "max-w-sm mx-2 my-4 overflow-hidden shadow-lg bg-slate-200 cursor-not-allowed" : "max-w-sm mx-2 my-4 overflow-hidden shadow-lg bg-grey"}>
      ...
      <div className="px-4 py-2">
        ...
        <p className= {status != "available" ? "text-base font-bold text-green-500" :"text-base font-bold text-green-500"}>
          {status}
        </p>
      </div>
